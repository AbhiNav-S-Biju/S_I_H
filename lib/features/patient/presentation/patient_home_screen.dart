        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // ----------------------------------------------------------------
              SupportiveMessage(
                message: 'Remember: your caregiver is always just a touch away, $preferredName.',
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      shape: BoxShape.circle,
                      boxShadow: ElderColors.clayShadow(color: ElderColors.pastelSky),
                    ),
                    child: const Icon(
                      Icons.alarm_rounded,
                      size: 24,
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: ElderColors.buttonShadow(color: ElderColors.skyDeep),
                    ),
                    child: Text(
                      formattedTime,
                      style: const TextStyle(
